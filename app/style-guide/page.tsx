    ...
    <div className="flex flex-1 flex-col bg-neutral-50">
      ...
      <main className="mx-auto flex w-full max-w-5xl flex-1 flex-col gap-12 px-4 py-10 sm:px-8">
        ...
        <section>
          ...
          <div className="grid gap-4 rounded-lg bg-surface p-5 shadow-sm sm:grid-cols-3">
        ...
        <section>
          ...
          <div className="flex flex-col gap-6 rounded-lg bg-surface p-5 shadow-sm">
        ...
        <section>
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {principles.map(({ icon: Icon, title, body }) => (
              <div key={title} className="rounded-lg bg-surface p-5 shadow-sm">
